...
// var montoMaxOperaciones = 2;
// var montoMinOperaciones = 1;
// var montoMaxDiario= 10;
// var montoMaxMensual= 11;
// var cantidadOperacionesDiarias=2;
// var cantidadOperacionesMensual=3;
// var montoAcumDiario=10;
// var montoAcumMensual=11;
// var acumCantidadOperacionesDiarias=2;
// var acumCantidadOperacionesMensual=2;
// var montoComision=2;
...
// -------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	function realizar_transferencia(cuentaOrigen, cuentaDestino, monto, descripcion, idUsuario, id_afil_terceros){
		...
		// $.post(base_url +"/transferencia/procesar",{"cuentaOrigen":cuentaOrigen,"cuentaDestino":cuentaDestino,"monto":monto,"descripcion":descripcion,"tipoOpe":"P2T","idUsuario":idUsuario,"id_afil_terceros":id_afil_terceros},function(data){

		// 	if(data.rc==0){

  //  			idTransferencia=data.dataTransaccion.referencia;
  //  			comision=data.dataTransaccion.comision;
