...
// ----------------------------------------------------------------------------------------------------------------------------------------------------------------
          ...
          $(".continuar").click(function(){
              ...
              $.post(base_url +"/affiliation/affiliation_P2T",{"nroPlasticoOrigen":numeroCtaOrigen,"beneficiario":beneficiario,"nroCuentaDestino":numeroCta,"tipoOperacion":"P2C","email":email,"cedula":cedula,"banco":banco,"prefix":prefix},function(data){
                  if(data.rc == -61){
                  ...
                  datos_finalizacion+=      '</tr>';
                  datos_finalizacion+=      '<tr>';
                  datos_finalizacion+=        '<td class="data-label"><label>Tarjeta de Crédito Destino</label></td>';
                  datos_finalizacion+=        '<td class="data-reference">"'+beneficiario+'"<span class="lighten">("'+email+'")</span><br />"'+cedula+'"<br /><span class="highlight">"'+numeroCta+'"</span><br /><span class="lighten">"'+banco+'"</span></td>';
                  datos_finalizacion+=      '</tr>';
