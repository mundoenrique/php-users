						...
						<fieldset>
								<ul class="row-profile">
									<li class="col-md-12-profile">
										...
										&nbsp;&nbsp;&nbsp;
										<label class="label-inline" for="contrato"><input id="contrato" name="contrato" type="checkbox"> Acepto el contrato de cuenta dinero electrónico plata beneficios</label>
									</li>
								</ul>
						</fieldset>
					</div>
