						...
						<div class="flex pb-5 px-2 flex-column">
							...
							<form id="sign-bulk-form" method="post">
								...
								<div class="flex row mt-3 mb-2 mx-2 justify-end">
									<div class="col-5 col-lg-3 col-xl-3 form-group">
										<div class="input-group">
											<input id="password-auth" name="password" class="form-control pwd-input pr-0 pwd" type="password" autocomplete="new-password" placeholder="<?= lang('GEN_PLACE_PASSWORD'); ?>">
											<div class="input-group-append">
									...
									<div class="col-auto">
										<button id="sign-bulk-btn" class="btn btn-primary btn-small btn-loading flex mx-auto">Actualizar</button>
									</div>
								</div>
							</form>
						</div>
