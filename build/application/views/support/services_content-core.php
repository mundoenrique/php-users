						...
						<div id="changeView" class="services-both max-width-1 fit-lg mx-auto fade-in">
							...
							<form id="formChange" accept-charset="utf-8" method="post">
								<div class="form-group">
									...
									<div class="custom-control custom-radio custom-control-inline">
										<input id="pin-request" class="custom-control-input" type="radio" name="recovery" value="request"
										 autocomplete="off">
								...
								<div id="changeVerificationOTP" class="none">
									...
									<div class="row">
										<div class="form-group col-lg-4">
											...
											<input id="changeCodeOTP" class="form-control" type="text" name="changeCodeOTP"
											 autocomplete="off">
						...
						<div id="replaceVerificationOTP" class="none">
							...
							<div class="row">
								<div class="form-group col-lg-4">
									...
									<input id="replaceCodeOTP" class="form-control" type="text" name="replaceCodeOTP"
									 autocomplete="off">
							...
							<div class="flex pb-5 px-2 flex-column">
								<div class="flex flex-column">
									...
									<div class="row flex justify-between my-3">
										...
										<div class="form-group col-4 center">
											<p class="h5 semibold tertiary"><?= lang('CUST_NAME'); ?>: <span class="light text">Jhonatan Ortiz</span></p>
										</div>
										<div class="form-group col-4 center">
											<p class="h5 semibold tertiary"><?= lang('CUST_DNI'); ?>: <span class="light text">1803752318</span></p>
										</div>
														...
														<div class="row">
															<div class="form-group col-12 col-lg-4">
																...
																<div class="input-group">
																	<input id="numberDayPurchasesCtp" class="money form-control pwd-input text-right" value="" type="text"
															...
															<div class="form-group col-12 col-lg-4">
																...
																<div class="input-group">
																	<input id="numberWeeklyPurchasesCtp" class="money form-control pwd-input text-right" type="text"
																	 autocomplete="off" name="" readonly>
																</div>
																<div class="help-block"></div>
															</div>
															<div class="form-group col-12 col-lg-4">
																...
																<div class="input-group">
																	<input id="numberMonthlyPurchasesCtp" class="money form-control pwd-input text-right" type="text"
																	 autocomplete="off" name="" readonly>
																</div>
																<div class="help-block"></div>
															</div>
															<div class="form-group col-12 col-lg-4">
																...
																<div class="input-group">
																	<input id="dailyPurchaseamountCtp" class="money form-control pwd-input text-right" type="text"
																	 autocomplete="off" name="" readonly>
																</div>
																<div class="help-block"></div>
															</div>
															<div class="form-group col-12 col-lg-4">
																...
																<div class="input-group">
																	<input id="weeklyAmountPurchasesCtp" class="money form-control pwd-input text-right" type="text"
																	 autocomplete="off" name="" readonly>
																</div>
																<div class="help-block"></div>
															</div>
															<div class="form-group col-12 col-lg-4">
																...
																<div class="input-group">
																	<input id="monthlyPurchasesAmountCtp" class="money form-control pwd-input text-right" type="text"
																	 autocomplete="off" name="" readonly>
																</div>
																<div class="help-block"></div>
															</div>
															<div class="form-group col-12 col-lg-4">
																...
																<div class="input-group">
																	<input id="purchaseTransactionCtp" class="money form-control pwd-input text-right" type="text"
																	 autocomplete="off" name="" readonly>
																</div>
																<div class="help-block"></div>
															</div>
													...
													<div class="col-12 mx-auto">
														<div class="row">
															<div class="form-group col-12 col-lg-4">
																...
																<div class="input-group">
																	<input id="numberDayPurchasesStp" class="money form-control pwd-input text-right" type="text"
																	 autocomplete="off" name="" readonly>
																</div>
																<div class="help-block"></div>
															</div>
															<div class="form-group col-12 col-lg-4">
																...
																<div class="input-group">
																	<input id="numberWeeklyPurchasesStp" class="money form-control pwd-input text-right" type="text"
																	 autocomplete="off" name="" readonly>
																</div>
																<div class="help-block"></div>
															</div>
															<div class="form-group col-12 col-lg-4">
																...
																<div class="input-group">
																	<input id="numberMonthlyPurchasesStp" class="money form-control pwd-input text-right" type="text"
																	 autocomplete="off" name="" readonly>
																</div>
																<div class="help-block"></div>
															</div>
															<div class="form-group col-12 col-lg-4">
																...
																<div class="input-group">
																	<input id="dailyPurchaseamountStp" class="money form-control pwd-input text-right" type="text"
																	 autocomplete="off" name="" readonly>
																</div>
																<div class="help-block"></div>
															</div>
															<div class="form-group col-12 col-lg-4">
																...
																<div class="input-group">
																	<input id="weeklyAmountPurchasesStp" class="money form-control pwd-input text-right" type="text"
																	 autocomplete="off" name="" readonly>
																</div>
																<div class="help-block"></div>
															</div>
															<div class="form-group col-12 col-lg-4">
																...
																<div class="input-group">
																	<input id="monthlyPurchasesAmountStp" class="money form-control pwd-input text-right" type="text"
																	 autocomplete="off" name="" readonly>
																</div>
																<div class="help-block"></div>
															</div>
															<div class="form-group col-12 col-lg-4">
																...
																<div class="input-group">
																	<input id="purchaseTransactionStp" class="money form-control pwd-input text-right" type="text"
																	 autocomplete="off" name="" readonly>
																</div>
																<div class="help-block"></div>
															</div>
													...
													<div class="col-12 mx-auto">
														<div class="row">
															<div class="form-group col-12 col-lg-4">
																...
																<div class="input-group">
																	<input id="dailyNumberWithdraw" class="money form-control pwd-input text-right" type="text"
																	 autocomplete="off" name="" readonly>
																</div>
																<div class="help-block"></div>
															</div>
															<div class="form-group col-12 col-lg-4">
																...
																<div class="input-group">
																	<input id="weeklyNumberWithdraw" class="money form-control pwd-input text-right" type="text"
																	 autocomplete="off" name="" readonly>
																</div>
																<div class="help-block"></div>
															</div>
															<div class="form-group col-12 col-lg-4">
																...
																<div class="input-group">
																	<input id="monthlyNumberWithdraw" class="money form-control pwd-input text-right" type="text"
																	 autocomplete="off" name="" readonly>
																</div>
																<div class="help-block"></div>
															</div>
															<div class="form-group col-12 col-lg-4">
																...
																<div class="input-group">
																	<input id="dailyAmountWithdraw" class="money form-control pwd-input text-right" type="text"
																	 autocomplete="off" name="" readonly>
																</div>
																<div class="help-block"></div>
															</div>
															<div class="form-group col-12 col-lg-4">
																...
																<div clxs="input-group">
																	<input id="weeklyAmountWithdraw" class="money form-control pwd-input text-right" type="text"
																	 autocomplete="off" name="" readonly>
																</div>
																<div class="help-block"></div>
															</div>
															<div class="form-group col-12 col-lg-4">
																...
																<div class="input-group">
																	<input id="monthlyAmountwithdraw" class="money form-control pwd-input text-right" type="text"
																	 autocomplete="off" name="" readonly>
																</div>
																<div class="help-block"></div>
															</div>
															<div class="form-group col-12 col-lg-4">
																...
																<div class="input-group">
																	<input id="WithdrawTransaction" class="money form-control pwd-input text-right" type="text"
																	 autocomplete="off" name="" readonly>
																</div>
																<div class="help-block"></div>
															</div>
									...
									<div class="row mx-xl-3">
										<div id="checked-form" class="form-group col-4 col-lg-4 col-xl-3 pb-3">
											...
											<div class="custom-control custom-switch custom-control-inline">
												<input id="travelAgency" class="custom-control-input" type="checkbox" name="travelAgency" disabled="disabled">
										...
										<div id="checked-form" class="form-group col-4 col-lg-4 col-xl-3 pb-3">
											...
											<div class="custom-control custom-switch custom-control-inline">
												<input id="insurers" class="custom-control-input" type="checkbox" name="insurers" disabled="disabled">
										...
										<div id="checked-form" class="form-group col-4 col-lg-4 col-xl-3 pb-3">
											...
											<div class="custom-control custom-switch custom-control-inline">
												<input id="charity" class="custom-control-input" type="checkbox" name="charity" disabled="disabled">
										...
										<div id="checked-form" class="form-group col-4 col-lg-4 col-xl-3 pb-3">
											...
											<div class="custom-control custom-switch custom-control-inline">
												<input id="entertainment" class="custom-control-input" type="checkbox" name="entertainment" disabled="disabled">
										...
										<div id="checked-form" class="form-group col-4 col-lg-4 col-xl-3 pb-3">
											...
											<div class="custom-control custom-switch custom-control-inline">
												<input id="parking" class="custom-control-input" type="checkbox" name="parking" disabled="disabled">
										...
										<div id="checked-form" class="form-group col-4 col-lg-4 col-xl-3 pb-3">
											...
											<div class="custom-control custom-switch custom-control-inline">
												<input id="gaStations" class="custom-control-input" type="checkbox" name="gaStations" disabled="disabled">
										...
										<div id="checked-form" class="form-group col-4 col-lg-4 col-xl-3 pb-3">
											...
											<div class="custom-control custom-switch custom-control-inline">
												<input id="governments" class="custom-control-input" type="checkbox" name="governments" disabled="disabled">
										...
										<div id="checked-form" class="form-group col-4 col-lg-4 col-xl-3 pb-3">
											...
											<div class="custom-control custom-switch custom-control-inline">
												<input id="hospitals" class="custom-control-input" type="checkbox" name="hospitals" disabled="disabled">
										...
										<div id="checked-form" class="form-group col-4 col-lg-4 col-xl-3 pb-3">
											...
											<div class="custom-control custom-switch custom-control-inline">
												<input id="hotels" class="custom-control-input" type="checkbox" name="hotels" disabled="disabled">
										...
										<div id="checked-form" class="form-group col-4 col-lg-4 col-xl-3 pb-3">
											...
											<div class="custom-control custom-switch custom-control-inline">
												<input id="debit" class="custom-control-input" type="checkbox" name="debit" disabled="disabled">
										...
										<div id="checked-form" class="form-group col-4 col-lg-4 col-xl-3 pb-3">
											...
											<div class="custom-control custom-switch custom-control-inline">
												<input id="toll" class="custom-control-input" type="checkbox" name="toll" disabled="disabled">
										...
										<div id="checked-form" class="form-group col-4 col-lg-4 col-xl-3 pb-3">
											...
											<div class="custom-control custom-switch custom-control-inline">
												<input id="restaurants" class="custom-control-input" type="checkbox" name="restaurants" disabled="disabled">
										...
										<div id="checked-form" class="form-group col-4 col-lg-4 col-xl-3 pb-3">
											...
											<div class="custom-control custom-switch custom-control-inline">
												<input id="supermarkets" class="custom-control-input" type="checkbox" name="supermarkets" disabled="disabled">
										...
										<div id="checked-form" class="form-group col-4 col-lg-4 col-xl-3 pb-3">
											...
											<div class="custom-control custom-switch custom-control-inline">
												<input id="telecommunication" class="custom-control-input" type="checkbox" name="telecommunication" disabled="disabled">
										...
										<div id="checked-form" class="form-group col-4 col-lg-4 col-xl-3 pb-3">
											...
											<div class="custom-control custom-switch custom-control-inline">
												<input id="airTransport" class="custom-control-input" type="checkbox" name="airTransport" disabled="disabled">
										...
										<div id="checked-form" class="form-group col-4 col-lg-4 col-xl-3 pb-3">
											...
											<div class="custom-control custom-switch custom-control-inline">
												<input id="collegesUniversities" class="custom-control-input" type="checkbox" name="collegesUniversities" disabled="disabled">
										...
										<div id="checked-form" class="form-group col-4 col-lg-4 col-xl-3 pb-3">
											...
											<div class="custom-control custom-switch custom-control-inline">
												<input id="retailSales" class="custom-control-input" type="checkbox" name="retailSales" disabled="disabled">
										...
										<div id="checked-form" class="form-group col-4 col-lg-4 col-xl-3 pb-3">
											...
											<div class="custom-control custom-switch custom-control-inline">
												<input id="passengerTransportation" class="custom-control-input" type="checkbox" name="passengerTransportation" disabled="disabled">
