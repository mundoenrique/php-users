...
<div class="pt-3 row">
            ...
            <div class="flex flex-colunm justify-center col-6 py-5">
              <div class="product-presentation relative">
                ...
                <div id="donor" class="product-search btn">
                  <a class="dialog button product-button"><span aria-hidden="true"
                      class="icon-find h1 icon-color"></span></a>
                  <input id="donor-cardnumber" name="donor-cardnumber" type="hidden" value="">
                </div>
                <?php else: ?>
                <img class="card-image" src="<?= $this->asset->insertFile($productImg, $productUrl); ?>"
                  alt="<?= $productName; ?>">
                <?php endif; ?>
              </div>
            </div>
  ...
  <div class="col-12 col-sm-12 col-lg-12 col-xl-8 pt-3">
    ...
    <div id="replacementRequestView" class="option-service"
      <?= $uniqueEvent && in_array('111', $serviceList) ? '' : 'style="display:none"'; ?>>
      <div class="flex mb-1 mx-4 flex-column">
            ...
            <form id="actionPinForm" name="actionPinForm">
              <div class="form-group">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                  <input id="changePin" class="custom-control-input" type="radio" name="recovery" value="change"
                    autocomplete="off">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                  <input id="generatePin" class="custom-control-input" type="radio" name="recovery" value="generate"
                    autocomplete="off">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                  <input id="requestPin" class="custom-control-input" type="radio" name="recovery" value="request"
                    autocomplete="off">
                          ...
                          <div class="row">
                            <div class="form-group col-12 col-lg-4">
                              ...
                              <div class="input-group">
                                <input id="numberDayPurchasesCtp" class="money form-control pwd-input text-right"
                                  value="" type="text" autocomplete="off" name="" readonly>
                              </div>
                              <div class="help-block"></div>
                            </div>
                            <div class="form-group col-12 col-lg-4">
                        ...
                        <div class="col-12 mx-auto">
                          <div class="row">
                            <div class="form-group col-12 col-lg-4">
                              ...
                              <div class="input-group">
                                <input id="dailyNumberCredit" class="money form-control pwd-input text-right"
                                  type="text" autocomplete="off" name="" readonly>
                              </div>
                              <div class="help-block"></div>
                            </div>
                            <div class="form-group col-12 col-lg-4">
                              ...
                              <div class="input-group">
                                <input id="weeklyNumberCredit" class="money form-control pwd-input text-right"
                                  type="text" autocomplete="off" name="" readonly>
                              </div>
                              <div class="help-block"></div>
                            </div>
                            ...
                            <div class="form-group col-12 col-lg-4">
                              ...
                              <div class="input-group">
                                <input id="dailyAmountCredit" class="money form-control pwd-input text-right"
                                  type="text" autocomplete="off" name="" readonly>
                              </div>
                              <div class="help-block"></div>
                            </div>
                            <div class="form-group col-12 col-lg-4">
                              ...
                              <div clxs="input-group">
                                <input id="weeklyAmountCredit" class="money form-control pwd-input text-right"
                                  type="text" autocomplete="off" name="" readonly>
                              </div>
                              <div class="help-block"></div>
                            </div>
                            ...
                            <div class="form-group col-12 col-lg-4">
                              ...
                              <div class="input-group">
                                <input id="CreditTransaction" class="money form-control pwd-input text-right"
                                  type="text" autocomplete="off" name="" readonly>
                              </div>
                              <div class="help-block"></div>
                            </div>
