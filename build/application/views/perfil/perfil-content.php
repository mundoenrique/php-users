...
?>
<div id="content" direccion1="<?php echo lang("DIR1");?>" direccion2="<?php echo lang("DIR2");?>" direccion3="<?php echo lang("DIR3");?>" acPais="<?php echo $acPais;?>" particular="<?php echo (int)$particular; ?>" primerNombre="<?php echo $primerNombre;?>" primerApellido="<?php echo $primerApellido;?>" segundoNombre="<?php echo $segundoNombre;?>" segundoApellido="<?php echo $segundoApellido;?>"
     profesion="<?php echo ucwords($profesion);?>" fechaNacimiento="<?php echo $fechaNacimiento;?>" descripcion_tipo_id_ext_per="<?php echo $descripcion_tipo_id_ext_per;?>" id_ext_per="<?php echo $id_ext_per;?>" acCiudad="<?php echo $acCiudad;?>"
                    ...
                    <fieldset class="col-md-12-profile">
                        <ul class="row-profile">
                            <li class="col-md-3-profile">
                                ...
                                <input type="text" id="tipo_identificacion" name="tipo_identificacion" value="<?php echo $datos->registro->user->descripcion_tipo_id_ext_per; ?>" readonly="readonly">

                                <input type="hidden" name="tipo_id_ext_per" id="tipo_id_ext_per" value="<?php echo $tipo_id_ext_per; ?>">
                                ...
                                <input type="hidden" name="disponeClaveSMS" id="disponeClaveSMS" value="<?php echo $disponeClaveSMS; ?>">
                        ...
                        <ul class="row-profile">
                            <li class="col-md-3-profile">
                                ...
                                <input class="field-medium" id="primer-nombre" maxlength="40" name="primer_nombre" type="text" value="<?php echo $datos->registro->user->primerNombre; ?>"/>
                            </li>
                            <li class="col-md-3-profile">
                                <label for="middle-name"> Segundo nombre</label>
                                <input class="field-medium" id="segundo-nombre" maxlength="40" name="segundo_nombre" type="text" value="<?php echo $datos->registro->user->segundoNombre; ?>"/>
                            </li>
                        </ul>
                        <ul class="row-profile">
                            <li class="col-md-3-profile">
                                <label for="last-name1">Primer apellido</label>
                                <input class="field-medium" id="primer-apellido" maxlength="40" name="primer_apellido" type="text" value="<?php echo $datos->registro->user->primerApellido; ?>" />
                            </li>
                            <li class="col-md-3-profile">
                                <label for="last-name2">Segundo apellido</label>
                                <input class="field-medium" id="segundo-apellido" maxlength="40" name="segundo_apellido" type="text" value="<?php echo $datos->registro->user->segundoApellido; ?>"/>
                            </li>
                        </ul>
                        ...
                        <ul class="row-profile row-fecha-nacimiento">
                            ...
                            <li class="col-profile-fecha-nac">
                                ...
                                <input id="fecha-nacimiento-valor" type="hidden" value="<?php echo $fechaNacimiento; ?>" name="fecha_nacimiento"/>
                            </li>
                        </ul>
                        ...
                        <ul class="row-profile row-modifica">
                            <li class="col-md-3-profile">
                                ...
                                <label class="label-inline" for="gender-male">
                                    <input id="gender_m" <?php if($datos->registro->user->sexo == 'M') echo 'checked="checked"'; ?> name="gender" type="radio" value="M" /> Masculino</label>
                                <label class="label-inline" for="gender-female">
                                    <input id="gender_f" <?php if($datos->registro->user->sexo == 'F') echo 'checked="checked"'; ?> name="gender" type="radio" value="F" /> Femenino</label>
                                </label>
                            </li>
                            <li class="col-md-3-profile remove-perfil-plata-sueldo">
                            ...
                            <li class="col-md-3-profile remove-perfil-plata-sueldo">
                                ...
                                <input type="text" id="nacionalidad-valor" maxlength="20" value="<?php echo $nacionalidad; ?>" name="nacionalidad">
                            </li>
                        </ul>
                        <ul class="row-profile row-modifica row-profesion">
                            <li class="col-md-full-profile">
                                ...
                                <select class="field-select-medium" id="listaProfesion" name="profesion">
                                    <input type="hidden" value="<?php echo $tipo_profesion; ?>" name="tipo_profesion" id="tipo_profesion_value">
                                </select>
                            </li>
                        </ul>
                    </fieldset>
                    ...
                    <fieldset class="col-md-12-profile">
                        ...
                        <ul class="row-profile" >
                            <li class="col-md-4-profile expand-row">
                                ...
                                <input type="hidden" id="pais-residencia-value" value="<?php echo $pais_residencia; ?>" name="paisResidencia">
                            </li>
                            <li class="col-md-4-profile expand-row">
                            ...
                            <fieldset class="col-md-12-profile">
                                ...
                                <ul class="row-profile">
                                    ...
                                    <li class="col-md-3-profile">
                                        ...
                                        <select class="field-select-medium profesion-labora" id="listaProfesion" name="profesion">
                                            <input type="hidden" value="<?php echo $profesion_laboral; ?>" class="tipo_profesion_value" name="tipo_profesion" id="tipo_profesion_value">
                                        </select>
                                    </li>
                                </ul>
                                <ul class="row-profile">
                                ...
                                <ul class="row-profile">
                                    ...
                                    <li class="col-md-3-profile">
                                        ...
                                        <input type="text" class="institucion_publica" maxlength="40" name="institucion_publica" value="<?php echo $institucion_publica; ?>" id="institucion_publica">
                                    </li>
                                </ul>
                                <ul class="row-profile">
                                    <li class="col-md-full-profile">
                        ...
                        <fieldset class="col-md-12-profile">
                            <ul class="row-profile">
                                <li class="col-md-3-profile">
                                    ...
                                    <input type="text" name="userName" value="<?php echo ucwords($datos->registro->user->userName); ?>" readonly="readonly">
                                </li>
                                <li class="col-md-3-profile">
                                    <label for="birth-date">Fecha de creación</label>
                                    <input type="text" value="<?php echo ucwords($datos->registro->user->dtfechorcrea_usu); ?>" name="dtfechorcrea_usu" id="dtfechorcrea_usu" readonly="readonly">
                                </li>
                                <li class="col-md-3-profile">
                            ...
                            <ul class="row-profile">
                                <li class="col-md-3-profile">
                                    ...
                                    <label for="password" class="link-config">
                                        <a href="<?php echo $this->config->item("base_url"); ?>/users/cambiarPassword?t=n">Ir a la configuración </a>
                                    </label>
                                </li>
                                <?php
