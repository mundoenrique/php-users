	...
	<ul id='dashboard-donor'>
		...
		<?php
			...
			foreach ($datos->cuentaOrigen as $value) {
				...
				echo "<li class='dashboard-item $empresa' card='" . $value->nroTarjeta . "' pais='$pais' moneda='$moneda' nombre='" . $tarjetaHabiente . "' marca='$marca' producto1='" . $nomProducto . "' mascara='" . $value->nroTarjetaMascara . "' empresa='$empresa' producto='$img' prefix='$value->prefix'>
         <a rel='section'>
