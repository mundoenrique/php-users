...
if ($skin == 'latodo') {
  $recoverUserLink = BASE_URL . '/users/obtenerLogin_pe';
  $recoverPwdLink = BASE_URL . '/users/recoveryPassword_pe';
} else if ($skin == 'pichincha') {
  $recoverUserLink = BASE_URL . '/users/obtenerLogin_pi';
  $recoverPwdLink = BASE_URL . '/users/recoveryPassword_pi';
} else {
  $recoverUserLink = BASE_URL . '/users/obtenerLogin';
  $recoverPwdLink = BASE_URL . '/users/recoveryPassword';
}
$signupLink = BASE_URL . '/registro';
?>
    ...
    <form id="form-login" name="form-login" accept-charset="utf-8" method="post">
      <fieldset>
        <div class="field-prepend">
          ...
          <input type="text" id="username" name="username" maxlength="15" autocomplete="off" placeholder="<?= $placeHolderUser ?>">
        </div>
        <div class="field-prepend">
          <?php if ($skin == 'pichincha') : ?>
          ...
          <input type="password" id="userpwd" name="userpwd" maxlength="15" autocomplete="off" placeholder="<?= $placeHolderPass ?>">
        </div>
      </fieldset>
    </form>
