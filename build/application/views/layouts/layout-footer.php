...
<div id="dialog-tc" style='display:none'>
  ...
  <div class="dialog-content">
    ...
    <?php elseif (ucwords($this->session->userdata('pais')) == 'Ve') : ?>
      <p><strong>Tebca Transferencia Electrónica de Beneficios, C.A</strong> domiciliada en la ciudad de Caracas e inscrita ante el Registro Mercantil Primero de la Circunscripción Judicial del Distrito Capital y Estado Miranda, en fechas 02 de agosto de 2004 y 12 de mayo de 2005 y registradas bajo los Nos. 79 y 72, Tomos 128-A-Pro. y 60-A-Pro., respectivamente, quienes en lo adelante, conjunta o indistintamente, se denominarán ”La Empresa”; a continuación describen los términos y condiciones que rigen el uso y la confidencialidad de esta plataforma electrónica, en lo adelante “La Plataforma”:</p>
