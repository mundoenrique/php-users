...
<body>
    ...
    <header class="main-head">
      <nav class="navbar navbar-expand-lg flex-auto bg-primary">
        <a class="navbar-brand" href="<?= base_url($rootHome); ?>">
          <img src="<?= $this->asset->insertFile('img-logo.svg', 'img', 'bdb'); ?>" alt="Logo Brand">
        </a>
        <?php
        if ($logged) {
        ?>
  ...
  <footer class="main-footer">
    <div class="flex pr-2 pr-lg-0">
      <img class="" src="<?= $this->asset->insertFile('img-mark.svg', 'img', 'bdb'); ?>" alt="Logo Superintendencia">
    </div>
    <div class="flex flex-auto flex-wrap justify-around items-center">
      ...
      <img class="order-1 mx-5" src="<?= $this->asset->insertFile('img-pci_compliance.svg', 'img', 'bdb'); ?>" alt="Logo PCI">
