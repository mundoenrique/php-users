	...
	<article>
		...
		<section>
			...
			<div id="content-holder">
				...
				<p>Ingrese los datos requeridos a continuación para afiliar una cuenta bancaria a la cual desee transferir fondos desde sus cuentas en determinado momento.</p>
				<form accept-charset="utf-8" id="validate_afiliacion"method="post">
					<fieldset>
	...
	<article>
		...
		<section>
			...
			<div id="content-holder">
				...
				<form accept-charset="utf-8" action="transfers-banks-add3.html" method="post">
		...
		<section>
			<nav id="secondary-menu">
				<ul class="menu">
					...
					<li class="menu-item handler">
						<a href="<? echo $this->config->item("base_url"); ?>/adm/adm_bank"
						   rel="section">Administrar Afiliaciones</a>
					</li>
					<li class="menu-item manage">
						<a href="<? echo $this->config->item("base_url"); ?>/transfer/index_bank" rel="section">Transferir</a>
					</li>
