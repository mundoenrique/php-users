          ...
          <div class="row">
            <?php if ($view != 'cardToCard') : ?>
              <div class="form-group col-6 col-lg-4">
                ...
                <select id="bank" class="custom-select form-control bank-afiliation" name="bank">
            ...
            <?php endif; ?>
            <?php if ($view != 'cardToCard') : ?>
              <div id="mobilePhoneBlock" class="form-group col-6 col-lg-4">
                <label for="mobilePhone"><?= lang('GEN_PHONE_MOBILE') ?></label>
                <input id="mobilePhone" class="form-control phone-afiliation" type="text" name="mobilePhone" autocomplete="off">
                <div class="help-block"></div>
              </div>
            <?php endif; ?>
            <div class="form-group col-6 col-lg-4">
