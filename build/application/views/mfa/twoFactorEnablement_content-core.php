...
<div id="recovery" class="recovery-content h-content hide-out hide">
	<div class="max-width-4 mx-auto p-responsive py-4">
		...
		<div class="pt-3 regular">
			<h2 class="text h4 mb-2"><?= lang('GEN_ACCOUNT_VERIFICATION'); ?></h2>
			...
			<div class="max-width-1 fit-lg mx-auto">
				<form id="twoFactorEnablementForm" class="mt-2" method="POST">
					<div class="form-group">
						<label class="mr-2"><?= lang('GEN_ACTIVATION_TYPE') ?></label>
						<div class="custom-control custom-radio custom-control-inline">
							<input id="twoFactorApp" name="twoFactorEnablement" class="custom-control-input" type="radio" value="<?= lang('GEN_APP') ?>" disabled>
							<label class="custom-control-label" for="twoFactorApp"><?= lang('GEN_USING_AN_APP'); ?></label>
						</div>
						<div class="custom-control custom-radio custom-control-inline">
						...
						<p class="visible" id="verifyMsg" ><?= lang('GEN_VERIFY_MSG_EMAIL'); ?></p>
					</div>
