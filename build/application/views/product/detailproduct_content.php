        ...
        <div class="flex max-width-4 flex-wrap items-start justify-between mb-2">
          <div class="product-presentation flex flex-column items-end mr-4">
            <div class="relative">
              ...
              <img class="card-image" src="<?= $this->asset->insertFile($data['nameImage'], 'images', $countryUri, 'programs'); ?>" alt="Tarjeta gris">
            </div>
            <div class="flex">
        ...
        <nav id="filtersStack" class="navbar detail-filters-nav p-1 px-lg-5 bg-widget">
          ...
          <ul class="stack list-inline mb-0 flex items-stretch">
            <li class="stack-item list-inline-item rounded">
              <a id="downloadPDF" class="block px-1" href="#" rel="subsection"><span class="icon-file-pdf h5 mr-0" aria-hidden="true"
                  title="Descargar PDF"></span></a>
            </li>
            <li class="stack-item list-inline-item rounded">
              <a id="downloadXLS" class="block px-1" href="#" rel="subsection"><span class="icon-file-excel h5 mr-0" aria-hidden="true"
                  title="Descargar Excel"></span></a>
            </li>
          ...
          <div id="transactions" class="group-main-view col-lg-8">
            ...
            <ul id="transitList" class="feed list-style-none mt-3 pl-0">
              ...
              <li class="feed-item <?= $row->signo == '+' ? 'feed-income' : 'feed-expense'; ?> flex py-1 items-center">
                ...
                <span
                  class="px-2 feed-amount items-center"><?= lang('GEN_COIN') . ' ' . ($row->signo == '+' ? '' : $row->signo) . $row->monto; ?></span>
              </li>
              <?php } ?>
            </ul>
            <?php
