    ...
    <div class="widget-product">
      <div class="line-text w-100">
        <div class="flex inline-flex col-12 px-xl-2">
          ...
          <input type="hidden" name="cardImage" class="hidden" id="cardImage" value="<?= $this->asset->insertFile($productImg, 'images', $customerFiles, 'programs'); ?>">
          <input type="hidden" name="cardImageRev" class="hidden" id="cardImageRev" value="<?= $this->asset->insertFile($productImgRev, 'images', $customerFiles, 'programs'); ?>">
        </div>
      </div>
    ...
    <nav id="filtersStack" class="navbar px-0">
      ...
      <?php if (lang('SETT_IN_TRANSIT') == 'ON') : ?>
        <div class="flex self-end mb-3">
          <button class="btn btn-outline btn-small btn-rounded-left bg-white" data-jplist-control="reset" data-group="group-filter-pagination" data-name="reset"><?= lang('GEN_MOVEMENTS'); ?></button>
          <button class="btn btn-outline btn-small btn-rounded-right nowrap is-disabled" data-jplist-control="reset" data-group="group-filter-pagination" data-name="reset"><?= lang('BUSINESS_TRANSIT_BALANCE'); ?></button>
        </div>
      <?php endif; ?>
    </nav>
