        ...
        <div class="flex inline-flex col-12 px-xl-2">
          <div id="productdetail" class="flex flex-column justify-center col-auto <?= $isVirtual ? 'pb-2': 'pb-4' ?> pt-4 pr-0">
            <div class="product-presentation relative">
              ...
              <img class="card-image" src="<?= $this->asset->insertImage($productImg, $customerImages, 'programs'); ?>" alt="<?= $productName; ?>">
            </div>
            <?php if ($isVirtual): ?>
          ...
          <input type="hidden" name="cardImage" class="hidden" id="cardImage"
            value="<?= $this->asset->insertImage($productImg, $customerImages, 'programs'); ?>">
          <input type="hidden" name="cardImageRev" class="hidden" id="cardImageRev"
            value="<?= $this->asset->insertImage($productImgRev, $customerImages, 'programs'); ?>">
        </div>
      </div>
        ...
        <div class="row pl-2">
          ...
          <div class="form-group col-4 px-1">
            <input id="filterInputYear" name="filterInputYear" class="form-control" name="datepicker" type="text"
              placeholder="<?= lang('GEN_DATEPICKER_DATEMEDIUM'); ?>" readonly autocomplete="off">
