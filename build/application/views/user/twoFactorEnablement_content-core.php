...
<div id="recovery" class="recovery-content h-content hide-out hide">
	<div class="max-width-4 mx-auto p-responsive py-4">
		...
		<div class="pt-3 regular">
			<h2 class="text h4 mb-2"><?= lang('USER_ACCOUNT_VERIFICATION'); ?></h2>
				...
				<form id="twoFactorEnablementForm" class="mt-2" method="POST">
					<div class="form-group">
						...
						<div class="custom-control custom-radio custom-control-inline">
							<input id="twoFactorApp" name="twoFactorEnablement" class="custom-control-input" type="radio" value="<?= lang('GEN_APP') ?>" checked disabled>
						...
						<p class="visible" id="verifyMsg" ><?= lang('USER_VERIFY_MSG_EMAIL'); ?></p>
					</div>
