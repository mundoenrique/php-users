...
<form id="profileUserForm" method="post" class="hide-out hide bg-color p-2">
	...
	<input id="creationDate" type="hidden" name="creationDate" value="<?= $creationDate; ?>">
	<input id="professionType" type="hidden" name="professionType" value="<?= $professionType; ?>">
	<input id="profession" type="hidden" name="profession" value="<?= $profession; ?>">
  ...
  <div class="row">
    ...
    <div class="form-group col-6 col-lg-4 col-xl-3">
      ...
      <input id="firstName" class="form-control" type="text" name="firstName" value="<?= $firstName; ?>" readonly autocomplete="off">
      <div class="help-block"></div>
    </div>
    <div class="form-group col-6 col-lg-4 col-xl-3">
      <label for="lastName"><?= lang('USER_PROFILE_LASTNAME')?></label>
      <input id="lastName" class="form-control" type="text" name="lastName" value="<?= $lastName; ?>" readonly autocomplete="off">
      <div class="help-block"></div>
    </div>
    <div class="form-group col-6 col-lg-4 col-xl-3">
    ...
    <div class="form-group col-6 col-lg-4 col-xl-3">
      <label for="surName"><?= lang('USER_PROFILE_SURNAME')?></label>
    ...
    <div class="form-group col-6 col-lg-4 col-xl-3">
      <label class="block"><?= lang('USER_PROFILE_GENDER')?></label>
  ...
  <div class="row">
    ...
    <div class="form-group col-6 col-lg-4 col-xl-3">
      <label for="email"><?= lang('USER_PROFILE_CONFIRM_EMAIL') ?></label>
    ...
    <div class="col-6 col-lg-4 col-xl-3">
      ...
      <div class="form-row">
        ...
        <div class="form-group col-6">
          <input id="otherPhoneNum" class="form-control" type="text" name="otherPhoneNum" value="<?= $otherPhoneNum; ?>"
  ...
  <div class="row">
    ...
    <?php if (lang('CONF_CHECK_NOTI_EMAIL') == 'ON' || lang('CONF_CHECK_NOTI_SMS') == 'ON' ): ?>
    <div class="form-group col-6 col-lg-4 col-xl-3">
      <label class="block"><?= lang('USER_PROFILE_NOTIFICATIONS')?></label>

      <?php if (lang('CONF_CHECK_NOTI_EMAIL') == 'ON'): ?>
      <div class="custom-control custom-switch custom-control-inline">
        <input id="notEmail" class="custom-control-input" type="checkbox" name="notEmail" <?= $emailNot == '1' ? 'checked' : '' ?>>
        <label class="custom-control-label" for="notEmail"><?= lang('USER_PROFILE_NOTIFICATIONS_EMAIL')?></label>
      </div>
      <?php endif; ?>
      ...
      <div class="custom-control custom-switch custom-control-inline">
        ...
        <label class="custom-control-label" for="notSms"><?= lang('USER_PROFILE_NOTIFICATIONS_SMS')?></label>
      </div>
      <?php endif; ?>
  ...
  <div class="row">
    <div class="col-6 col-lg-4 col-xl-3">
      <a class="btn btn-small btn-link px-0 hyper-link big-modal"
        href="<?= base_url(lang('GEN_LINK_CHANGE_PASS')); ?>"><?= lang('USER_PROFILE_CHANGE_PASSWORD')?></a>
    </div>
