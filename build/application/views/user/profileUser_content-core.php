					...
					<fieldset class="form-group ms-step-<?= $index ?> mb-0 active seen border-none" data-index=<?= $index ?>>
						<div class="col-12">
            				...
            				<input id="birthDate" class="form-control <?= $updateUser; ?>" type="text" name="birthDate" value="<?= $birthday; ?>" readonly autocomplete="off">
            					...
            					<input id="nationality" class="form-control <?= $updateUser; ?>" type="text" name="nationality" value="<?= $nationality; ?>" autocomplete="off">
											<div class="help-block"></div>
										</div>
										<div class="form-group col-6 col-lg-3 input-height">
            					...
            					<input id="verifierCode" class="form-control <?= $updateUser; ?>" type="text" name="verifierCode" value="<?= $verifierCode; ?>" maxlength="1" <?= $verifierCode != '' ? 'readonly' : ''; ?>>
											<div class="help-block"></div>
										</div>
									<?php endif; ?>
									<div class="form-group col-6 col-lg-3">
										...
										<div class="flex">
											<div class="custom-control custom-radio custom-control-inline">
												<input id="genderMale" class="custom-control-input" type="radio" name="gender" value="M" <?= $gender == 'M' ? 'checked' : ''; ?> <?= $disabled; ?>>
												<label class="custom-control-label <?= $updateUser; ?>" for="genderMale"><?= lang('USER_GENDER_MALE'); ?></label>
											</div>
											<div class="custom-control custom-radio custom-control-inline">
												<input id="genderFemale" class="custom-control-input" type="radio" name="gender" value="F" <?= $gender == 'F' ? 'checked' : ''; ?> <?= $disabled; ?>>
							...
							<div class="bg-secondary h-100">
								<div class="row mx-1 <?= $skipContacData; ?>">
									...
									<div class="form-group col-6 col-lg-3 input-height">
										...
										<input id="postalCode" class="form-control <?= $updateUser; ?> <?= $ignoreContacData; ?>" type="text" name="postalCode" value="<?= $postalCode; ?>" autocomplete="off">
										<div class="help-block"></div>
									</div>
									<div class="form-group col-6 col-lg-3 input-height">
								...
								<div class="row mx-1">
									<div class="form-group col-6 col-lg-4 input-height">
										...
										<input id="email" class="form-control <?= $updateUser; ?>" type="text" name="email" value="<?= $email; ?>" <?= $updateEmail; ?> placeholder="usuario@ejemplo.com" autocomplete="off">
					...
					<?php if ($longProfile == 'S') : ?>
						...
						<fieldset class="form-group ms-step-<?= $index ?> mb-0 border-none" data-index=<?= $index ?>>
							<div class="col-12">
            					...
            					<input id="averageIncome" class="form-control text-right" type="text" name="averageIncome" value="<?= $averageIncome ?>" autocomplete="off">
											<div class="help-block"></div>
										</div>
								...
								<div class="bg-secondary p-2">
									<div class="row mx-1">
										<div class="form-group custom-control custom-switch col-12 col-lg-6 pt-1">
											<input id="protection" class="custom-control-input" type="checkbox" name="protection" <?= $contract == '1' ? 'checked disabled' : '' ?>>
											<label class="custom-control-label" for="protection"><?= lang('USER_ACCEPT_PROTECTION'); ?></label>
											<div class="help-block"></div>
										</div>
										<div class="form-group custom-control custom-switch col-12 col-lg-6 pt-1">
											<input id="contract" class="custom-control-input" type="checkbox" name="contract" <?= $protection == '1' ? 'checked disabled' : '' ?>>
