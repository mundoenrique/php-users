        ...
        <div class="row">
          ...
          <div class="form-group col-6 col-lg-6 px-1 mb-2">
            <div class="drop-zone INE_A label-file p-1">
							<?php if(count($imagesLoaded) > 0 && array_key_exists('base64', $imagesLoaded['INE_A'])):?>
          ...
          <div class="form-group col-6 col-lg-6 px-1 mb-2">
            <div class="drop-zone INE_R label-file p-1">
							<?php if(count($imagesLoaded) > 0 && array_key_exists('base64', $imagesLoaded['INE_R'])):?>
          ...
          <div class="form-group col-6 col-lg-6 px-1 mb-2">
            <div class="drop-zone label-file p-1">
              <div class="drop-zone-prompt flex flex-column items-center">
								<?php if(count($imagesLoaded) > 0 && array_key_exists('base64', $imagesLoaded['PASS_A'])):?>
          ...
          <div class="form-group col-6 col-lg-6 px-1 mb-2">
            <div class="drop-zone label-file p-1">
              <div class="drop-zone-prompt flex flex-column items-center">
								<?php if(count($imagesLoaded) > 0 && array_key_exists('base64', $imagesLoaded['PASS_R'])):?>
