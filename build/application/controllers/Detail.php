...
// ----------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	public function index()
	{
		...
		$FooterCustomInsertJS = array('jquery-3.6.0.min.js', 'jquery-ui-1.13.1.min.js', 'jquery.isotope.min.js', 'cypher/aes.min.js', 'cypher/aes-json-format.min.js', 'detail.js', 'kendo.dataviz.min.js');
