...
<ol>
	<li>
		<p><b>Objeto</b></p>
		<p>Para tener acceso al Servicio, el Tarjetahabiente Autorizado por el Cliente (en lo sucesivo el <b>“Tarjetahabiente”</b>), deberá contar con autorización del Cliente así como el(los) usuario(s) y contraseña(s) para acceder a la plataforma la cual permite al Tarjetahabiente administrar y visualizar las condiciones de su Tarjeta de Débito, la cual el Cliente a través de las peticiones que realice a Banorte, expida a su nombre con cargo a la Cuenta Concentradora(en lo sucesivo, la <b>“Plataforma”</b>).</p>
		<p>Grupo Financiero Banorte, S.A.B. de C.V., sus entidades subsidiarias y filiales en lo sucesivo "Banorte" requieren que el Cliente, el Tarjetahabiente y todos los visitantes la Plataforma se adhieran a las siguientes reglas y condiciones, y a cualesquiera otros contratos de servicios, según sea el caso, que sean requeridos por Banorte para servicios o productos específicos.</p>
		<p>Por el hecho de tener acceso a la Plataforma, el Tarjetahabiente expresa su aceptación y acuerdo con estos términos y condiciones, según sean modificados, así como con cada modificación a los mismos que haga Banorte de momento a momento.</p>
	</li>
	<li>
		<p><b>Definiciones</b></p>
		<ul>
			<li type="disc">
				<p><b>Cliente:</b> La persona identificada en la Carátula de Activación y Datos Generales del Contrato de Prestación de Servicios de Tarjeta de Débito Empresarial.</p>
			</li>
			<li type="disc">
	...
	<li>
		...
		<p>El Cliente y el Tarjetahabiente para todos los efectos legales a que haya lugar, expresamente reconocen y aceptan el carácter personal e intransferible de la Tarjeta de Débito, así como la confidencialidad del NIP asignado.</p>
		<p>Por lo tanto, es exclusiva responsabilidad del Cliente y/o del Tarjetahabiente cualquier quebranto que pudiera sufrir como consecuencia del uso indebido que llegara a hacerse de las referidas Tarjetas de Débito o del NIP.</p>
		<p>El Tarjetahabiente reconoce y acepta expresamente que las Tarjetas de Débito son propiedad exclusiva del Banco.</p>
	</li>
	<li>
	...
	<li>
		...
		<p>La Plataforma se pone a disposición del Tarjetahabiente, en el estado en el que se encuentra, sin garantía, por lo que Banorte no será responsable ante intermitencia o indisponibilidad de la Plataforma.</p>
	</li>
	<li>
