...
define('ARGON2_MEMORY_COST', $_SERVER['ARGON2_MEMORY_COST'] ?? PASSWORD_ARGON2_DEFAULT_MEMORY_COST);
define('ARGON2_TIME_COST', $_SERVER['ARGON2_TIME_COST'] ?? PASSWORD_ARGON2_DEFAULT_TIME_COST);
define('ARGON2_THREADS', $_SERVER['ARGON2_THREADS'] ?? PASSWORD_ARGON2_DEFAULT_THREADS);
define('ARGON2_TYPE_ALG', $_SERVER['ARGON2_TYPE_ALG'] ?? PASSWORD_ARGON2ID);
define('ARGON2_SALT', $_SERVER['ARGON2_SALT'] ?? 'egVyjtrK2heeCpgvqQfFkN4FfzjAWmR2ZtgPwdGLyAj5SEN5dmq25QngTW5');
